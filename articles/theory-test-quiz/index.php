  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    ...
    <header class="page-header dark imgix-fluid-bg dark-overlay" data-src="https://firstcar.imgix.net/articles/<? echo $page[''.$page_id.'']['id'];?>/images/page-header.jpg?auto=format,enhance&fit=crop" role="banner">
        ...
        <div class="article-intro offset-by-six columns">
            ...
            <h1>Official DVSA practice questions</h1>
            <p>See if you’re ready to take the theory test with our interactive quiz</p>
        </div><!-- /five columns -->
...
<!-- End Document
  ...
  <!-- SLICKQUIZ -->
  <script src="<?= $path;?>/js/min/slickQuiz-ck.js"></script>
  <script src="<?= $path;?>/js/min/slickQuiz-config-ck.js"></script>
  <script>
    $(function () {
        $('#slickQuiz').slickQuiz({
