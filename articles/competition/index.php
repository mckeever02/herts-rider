  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    ...
    <article class="standard-article">
        ...
        <section class="container">
          <div class="row">
            <div class="four columns">
              <div class="imgix-fluid-bg imgix-image" style="padding-bottom:60%;" data-src="https://herts-rider.imgix.net/articles/<? echo $page[''.$page_id.'']['id'];?>/images/chain-lock.jpg" alt="Lampa Kiton chain lock"></div>
              <div class="u-text-center">
            ...
            <div class="four columns">
              <div class="imgix-fluid-bg imgix-image" style="padding-bottom:60%;" data-src="https://herts-rider.imgix.net/articles/<? echo $page[''.$page_id.'']['id'];?>/images/gloves.jpg" alt="ARMR S550 gloves"></div>
              <div class="u-text-center">
            ...
            <div class="four columns">
              <div class="imgix-fluid-bg imgix-image" style="padding-bottom:60%;" data-src="https://herts-rider.imgix.net/articles/<? echo $page[''.$page_id.'']['id'];?>/images/boots.jpg" alt="Falco Boots Oxegen"></div>
              <div class="u-text-center">
        ...
        <section class="container">
          ...
          <div class="u-center-table">
            <h2>Enter for your chance to win</h2>
