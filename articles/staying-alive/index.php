  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    ...
    <header class="page-header dark imgix-fluid-bg dark-overlay" data-src="https://firstcar.imgix.net/articles/<? echo $page[''.$page_id.'']['id'];?>/images/page-header.jpg?auto=format,enhance&fit=crop" role="banner">
        ...
        <div class="article-intro offset-by-six columns">
            ...
            <h1>Staying alive</h1>
            <p>If you’re new to biking you’ll be inexperienced. But if you’ve been biking for years there’s a danger you could be getting complacent</p>
        </div>
    ...
    <article class="standard-article">
        ...
        <section class="container wow fadeInUp">
          ...
          <div class="longform-text-container">
            <p class="introduction">It’s easy to forget about some of the basics when it comes to biking safety, but if you keep on top of these you should be able to look forward to a great season in the saddle.</p>

            <p>Motorcyclists make up 1% of the total traffic on the UK’s roads, but account for over 20% of the total numbers killed or seriously injured. Or put another way, you’re over 20 times more likely to be involved in a crash on a motorcycle than in a car.</p>
