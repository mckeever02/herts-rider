  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    ...
    <div class="container">
        <a href="<? echo $page_issue2[''.$page_id.'']['url'];?>" target="_blank">
            <div class="imgix-fluid-bg" style="padding-bottom:62%;" data-src="<? echo $imgix_path_ads ?><? echo $page_issue2[''.$page_id.'']['id'];?>/ad.jpg" alt="<? echo $page_issue2[''.$page_id.'']['title'];?>"></div>
        </a>
