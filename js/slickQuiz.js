...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Show Answer',
                nextQuestionText: 'Next Question',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: '%current',
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="button button-primary button-small allports ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a></p>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="button button-primary allports ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<div class="u-center quizNav"><a href="#" class="button button-primary allports ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a></div>');
                        } else {
                            questionHTML.append('<div class="u-center quizNav"><a href="#" class="button button-primary allports ' + nextQuestionClass + '">' + nextText + '</a></div>');
                            questionHTML.append('<div class="u-center quizNav"><a href="#" class="button button-primary allports ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a></div>');
                        }
