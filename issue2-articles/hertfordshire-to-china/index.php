        ...
        <div class="row">
          ...
          <div class="one-third column">
              <a href="http://www.bmf.co.uk/" target="_blank">
                  <div class="imgix-fluid-bg imgix-image" style="padding-bottom:100%;" data-src="<? echo $imgix_path ?><? echo $page[''.$page_id.'']['id'];?>/images/bmf-inline-ad.jpg" alt="British Motorcyclists Federation"></div>
              </a>
          </div>
