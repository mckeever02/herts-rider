<?php
    ...
    '5' => array(
        'id'    => 'win-a-car',
        'title' => 'Win a car',
        'blurb'  => 'Fancy picking up a new Fiesta or Corsa for free? We thought you might.',
        'type'  => 'articles'),
    '6' => array(
        'id'    => 'what-type-of-learner-are-you',
        'title' => 'What type of learner are you?',
        'blurb'  => 'We learn in different ways; find the method that works best for you.',
        'type'  => 'articles'),
    '7' => array(
        'id'    => 'find-the-perfect-instructor',
        'title' => 'Find the perfect instructor',
        'blurb'  => 'How to track down someone who’ll inject some spark into the learning process.',
        'type'  => 'articles'),
    '8' => array(
        'id'    => 'bsm-go',
        'title' => 'Get ready, go!',
        ...
        'type'  => 'ads'),
    '9' => array(
        'id'    => 'make-the-most-of-your-lessons',
        'title' => 'Make the most of your lessons',
        'blurb'  => 'Driving lessons are costly, so make sure you get the most out of them.',
        'type'  => 'articles'),
    '10' => array(
        'id'    => 'intensive-driving-courses',
        'title' => 'Intensive driving courses',
        'blurb'  => 'How to cram the learning process into just a week – but should you do so?',
        'type'  => 'articles'),
    '11' => array(
        'id'    => 'learning-with-your-parents',
        'title' => 'Learning with your parents',
        'blurb'  => 'Practising between lessons is essential – but how do you make parent tuition work?',
        'type'  => 'articles'),
    '12' => array(
        'id'    => 'bsm-learner-apps',
        'title' => 'Learner apps',
        ...
        'type'  => 'ads'),
    '13' => array(
        'id'    => 'independent-instructors',
        'title' => 'Independent instructors',
        'blurb'  => 'You don’t have to learn with a driving school – there’s a stack of independent instructors out there eager to get you on the road.',
        'type'  => 'articles'),
    '14' => array(
    ...
    '15' => array(
        ...
        'blurb'  => 'Worried you can’t get cover for the family car? Fret not because help is here.',
        'type'  => 'articles'),
    '16' => array(
        ...
        'type'  => 'ads'),
    '17' => array(
        'id'    => 'how-the-theory-test-works',
        'title' => 'How the theory test works',
        'blurb'  => 'Baffled by how the theory test works? No need to be; it’s very straightforward.',
        'type'  => 'articles'),
    '18' => array(
        'id'    => 'theory-test-quiz',
        'title' => 'Theory test quiz',
        'blurb'  => 'You won’t get very far if you don’t know your Highway Code. Brush up here.',
        'type'  => 'articles'),
    '19' => array(
