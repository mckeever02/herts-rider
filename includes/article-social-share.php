<section class="social-share container u-center">
    ...
    <a href="http://www.facebook.com/sharer/sharer.php?s=100&p[url]=<? echo $url ?>articles/<? echo $page_issue2[''.$page_id.'']['id'];?>&p[images][0]=<? echo $url ?>articles/<? echo $page_issue2[''.$page_id.'']['id'];?>/page-header.jpg&p[title]=<? echo $page_issue2[''.$page_id.'']['title'];?>&p[summary]=<? echo $page_issue2[''.$page_id.'']['blurb'];?>" class="button-tertiary button-social button-facebook" target="_blank">
    ...
    <a href="http://twitter.com/home?status=I just read <? echo $page_issue2[''.$page_id.'']['title'];?> at: <? echo $url ?>articles/<? echo $page_issue2[''.$page_id.'']['id'];?>" class="button-tertiary button-social button-twitter" target="_blank">
      <svg class="icon" x="0px" y="0px" width="40px" height="40px" viewBox="0 0 40 40">
        <g>
    ...
    <a href="mailto:?subject=<? echo $page_issue2[''.$page_id.'']['title'];?> article&body=Check this article out: <? echo $url ?>articles/<? echo $page_issue2[''.$page_id.'']['id'];?>" class="button-tertiary button-social button-email" target="_blank">
      <svg class="icon" x="0px" y="0px" width="40px" height="40px" viewBox="0 0 40 40">
        <g>
